...
def compute_metrics(ref_file_path, pred_file_path):
    # Read reference and predicted files
    ref_x, ref_fs = sf.read(ref_file_path, dtype="float32")
    pred_x, pred_fs = sf.read(pred_file_path, dtype="float32")
